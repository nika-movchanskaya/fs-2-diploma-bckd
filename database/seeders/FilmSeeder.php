    ...
    public function run(): void
    {
        Film::insert([
            [
                ...
                'origin' => 'USA',
                'duration' => 142,
                'image' => 'films_img/91WV6FP4L_AC_SY879_.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'origin' => 'USA',
                'duration' => 169,
                'image' => 'films_img/91vIHsL-zjL._AC_SY879_.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'origin' => 'USA',
                'duration' => 152,
                'image' => 'films_img/4lj1ikfsSmMZNyfdi8R8Tv5tsgb.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'origin' => 'USA',
                'duration' => 162,
                'image' => 'films_img/8064160_1.10.jpeg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'origin' => 'USA',
                'duration' => 139,
                'image' => 'films_img/51tRn1L9FfL._AC_UF894,1000_QL80_.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
